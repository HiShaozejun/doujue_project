...
import 'package:djqs/base/widget/city_pickers/meta/province.dart';
...
//    itemHeight = widget.cityItemHeight;
  ...
  _dynamicChangeTopStagePosition(double scrollTopOffset) {
    ...
    }, orElse: () => null as CityOffsetRange);
...
//      print("补偿运算");
  ...
  CityPickerResult _buildResult(Point city) {
...
//    print("_initTargetCity.code ${_initTargetCity}");
    ...
    if (_isTouchTagBar) {
      children.add(_buildCenterModel());
    }
